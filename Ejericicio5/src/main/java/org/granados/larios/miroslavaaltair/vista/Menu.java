...
public class Menu
{
    ...
    public static void menuDiagonal1( ) {System.out.println( "Dame una diagonal");}
    public static void menuDiagonal2( ) {System.out.println( "Dame otra diagonal");}
    public static void menuBase2( ) {System.out.println( "Dame una Base 2");}
    public static void menuCirculo( ) {System.out.println( "Dame un Radio");}
}